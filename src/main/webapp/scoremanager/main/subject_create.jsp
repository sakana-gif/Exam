		...
		<section>
			...
			<form action="SubjectCreate.action" method="get">
				<div>
					...
					<input class="form-control" type="text" id="cd" name="cd" value="${cd }" maxlength="3" placeholder="科目コードを入力してください" />
				</div>
				<div class="mt-2 text-warning">${errors.get("1") }</div>
				<div class="mt-2 text-warning">${error }</div>
				<div>
					<label for="name">科目名</label><br>
					<input class="form-control" type="text" id="name" name="name" value="${name }" maxlength="20" placeholder="科目名を入力してください" />
				</div>
